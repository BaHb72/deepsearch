...
- 2025-10-21：形成《[市场行情缓存与资源治理](../plans/README.md#市场行情缓存与资源治理)》，明确实时/日频链路的 Redis、DuckDB
  复用策略。
...
- **产品规划（参见 [阶段性计划汇总-市场盘面产品规划 V4](../plans/README.md#市场盘面产品规划-v4)）**：强调“Real-time First”，基于 AmazingData
