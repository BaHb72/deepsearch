...
# 5. 测试get_long_hu_bang
print("\n[5] 测试 get_long_hu_bang (龙虎榜)...")
print(f"    调用: info_data.get_long_hu_bang(")
print(f"        code_list={CODE_LIST},")
print(f"        local_path='{LOCAL_PATH}',")
print(f"        is_local={IS_LOCAL},")
print(f"        begin_date={BEGIN_DATE},")
...
# 6. 测试get_balance_sheet (资产负债表没有begin_date/end_date，只有local_path和is_local)
print("\n[6] 测试 get_balance_sheet (资产负债表)...")
print(f"    调用: info_data.get_balance_sheet(")
print(f"        code_list={CODE_LIST},")
print(f"        local_path='{LOCAL_PATH}',")
print(f"        is_local={IS_LOCAL}")
print(f"    )")
...
print(f"    调用: info_data.get_margin_summary(")
print(f"        local_path='{LOCAL_PATH}',")
print(f"        is_local={IS_LOCAL},")
print(f"        begin_date={BEGIN_DATE},")
print(f"        end_date={END_DATE}")
...
print(f"    调用: info_data.get_margin_detail(")
print(f"        code_list={CODE_LIST},")
print(f"        local_path='{LOCAL_PATH}',")
print(f"        is_local={IS_LOCAL},")
print(f"        begin_date={BEGIN_DATE},")
...
print(f"    调用: info_data.get_profit_express(")
print(f"        code_list={CODE_LIST},")
print(f"        local_path='{LOCAL_PATH}',")
print(f"        is_local={IS_LOCAL},")
print(f"        begin_date={BEGIN_DATE},")
