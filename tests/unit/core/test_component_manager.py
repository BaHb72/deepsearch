...
class TestComponentManager:
    ...
    def test_register_component(self, component_manager, mock_component):
        ...
        component_manager.register_component(
            component=mock_component, display_name="Test Component", description="A test component"
        )
    ...
    def test_register_component_with_dependencies(self, component_manager):
        ...
        component_manager.register_component(
            component=dep_component, display_name="Dependency", description="A dependency component"
        )
    ...
    def test_get_all_components(self, component_manager):
        ...
        component_manager.register_component(
            component=component1, display_name="Component 1", description="First component"
        )
        component_manager.register_component(
            component=component2, display_name="Component 2", description="Second component"
        )
    ...
    def test_get_components_by_type(self, component_manager):
        ...
        component_manager.register_component(
            component=data_component, display_name="Data Component", description="Data component"
        )
        component_manager.register_component(
    ...
    async def test_dependency_order(self, component_manager):
        ...
        # comp3 -> comp2 -> comp1
        component_manager.register_component(
            component=comp1, display_name="Component 1", description="Base component"
        )
        component_manager.register_component(
            component=comp2,
    ...
    def test_component_error_handling(self, component_manager):
        ...
        component_manager.register_component(
            component=error_comp, display_name="Error Component", description="Component that fails"
        )
    ...
    def test_component_metrics(self, component_manager, mock_component):
        ...
        # 更新组件指标
        component_manager.update_component_metrics(
            "test_component", {"requests_processed": 100, "errors": 5, "average_latency": 0.05}
        )
    ...
    def test_get_status_summary(self, component_manager):
        ...
        component_manager.register_component(
            component=comp1, display_name="Component 1", description="Running component"
        )
        component_manager.register_component(
            component=comp2, display_name="Component 2", description="Stopped component"
        )
        component_manager.register_component(
            component=comp3, display_name="Component 3", description="Error component"
        )
...
class TestComponentManagerIntegration:
    ...
    async def test_full_lifecycle(self, component_manager):
        ...
        await component_manager.initialize_all()
        assert all(
            comp.status == ComponentStatus.INITIALIZED
        ...
        await component_manager.start_all()
        assert all(
            comp.status == ComponentStatus.RUNNING for comp in [data_comp, analytics_comp, ui_comp]
        )
        ...
        await component_manager.stop_all()
        assert all(
            comp.status == ComponentStatus.STOPPED for comp in [data_comp, analytics_comp, ui_comp]
        )
