...
class TestMonitoringStatus:
    ...
    async def test_get_system_status(self):
        ...
        assert all(
            v in ["running", "operational", "healthy"] for v in status["components"].values()
        )
...
class TestMetricsCollection:
    ...
    async def test_get_system_metrics(self):
        ...
        metrics = {
            "cpu": {"usage_percent": 45.5, "cores": 8, "load_average": [2.5, 2.1, 1.8]},
            "memory": {"used_gb": 8.5, "total_gb": 16.0, "percent": 53.1, "available_gb": 7.5},
            "disk": {"used_gb": 250, "total_gb": 500, "percent": 50.0},
            "network": {
                "bytes_sent": 1000000,
                "bytes_recv": 2000000,
                "packets_sent": 10000,
    ...
    async def test_get_api_metrics(self):
        ...
        api_metrics = {
            ...
            "success_rate": 99.5,
            "error_rate": 0.5,
            "response_times": {"p50": 10, "p95": 50, "p99": 100, "max": 500},
            "endpoints": [
                {"path": "/api/market/realtime/*", "count": 50000, "avg_time_ms": 15},
                {"path": "/api/data-sources/status", "count": 10000, "avg_time_ms": 5},
            ],
        }
    ...
    async def test_get_data_source_metrics(self):
        ...
        assert list(ds_metrics.keys()) == ["amazingdata"]
        assert ds_metrics["amazingdata"]["success_rate"] > 99
...
class TestEventMonitoring:
    ...
    async def test_get_recent_events(self):
        ...
        events = [
            ...
            },
            {
                ...
                "level": "warning",
                "source": "data_source",
                "message": "AmazingData heartbeat delayed, latency > 100ms",
            },
            {
                "id": 1003,
    ...
    async def test_filter_events_by_level(self):
        ...
        important_events = [e for e in all_events if e["level"] in ["warning", "error", "critical"]]
