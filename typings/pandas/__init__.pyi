...
class Series:
    ...
    def clip(
        self, lower: Any | None = ..., upper: Any | None = ..., *args: Any, **kwargs: Any
    ) -> "Series": ...
    ...
    def replace(
        self, to_replace: Any, value: Any | None = ..., *args: Any, **kwargs: Any
    ) -> "Series": ...
    def rolling(
        self, window: Any, min_periods: Any | None = ..., *args: Any, **kwargs: Any
    ) -> Rolling: ...
...
def concat(
    objs: Sequence[Any], axis: int = ..., join: str = ..., ignore_index: bool = ...
) -> DataFrame: ...
