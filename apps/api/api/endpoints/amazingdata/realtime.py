...
from core.domain.concept_engine import get_concept_engine
...
async def subscribe_kline(request: KlineSubscribeRequest) -> JSONDict:
    ...
    try:
        ...
        await provider.subscribe_kline(code_list=request.code_list, callback=on_kline)
        ...
        while True:
            ...
            if message.get("action") == "subscribe":
                ...
                await websocket.send_json(
                    {"type": "subscription_confirmed", "subtype": "concept_flow"}
                )
