...
from core.core.managers.component_manager import ComponentManager, ComponentStatus, ComponentType
...
async def get_aggregation_status() -> Dict[str, Any]:
    """获取聚合引擎状态。"""
    try:
        from core.application.services.aggregation import get_cache, get_engine
...
async def start_aggregation() -> Dict[str, Any]:
    """启动聚合引擎。"""
    try:
        from core.application.services.unified_data import start_aggregation_engine
...
async def stop_aggregation() -> Dict[str, Any]:
    """停止聚合引擎。"""
    try:
        from core.application.services.unified_data import stop_aggregation_engine
