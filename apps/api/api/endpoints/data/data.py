...
from core.indicators.simple import SimpleIndicators
from core.infrastructure.persistence.analytics import AnalyticsDB
from core.infrastructure.persistence.database import DatabaseService
from core.infrastructure.persistence.models.market import Market1Min, MarketTick
...
from core.utils.data_sources import DataSourceManager, get_data_source_manager
...
async def get_kline_data(
    ...
    try:
        ...
        try:
            ...
            if test_mode:
                from apps.api.api.common.response_format import APIResponse
