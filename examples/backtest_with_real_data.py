...
from deepsearch.backtest import BacktestEngine, DataBridge, SimpleMovingAverageStrategy
...
async def demo_data_compatibility():
    ...
    print(
        f"   Data validation: {'Passed' if len(bridge.validation_errors) == 0 else 'Has warnings'}"
    )
    ...
    print("   Data ready for Backtrader: Yes")
    ...
    try:
        ...
        print("\n4. Backtrader feed creation...")
        print("   [INFO] Backtrader feed created but cannot be directly tested")
