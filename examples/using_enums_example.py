...
def example_2_right_issue_progress():
    ...
    approved = [issue for issue in mock_right_issues if issue["PROGRESS"] in approved_stages]
...
def example_3_dividend_progress():
    ...
    in_progress = [div for div in mock_dividends if div["DIV_PROGRESS"] in in_progress_stages]
