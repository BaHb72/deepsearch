...
def verify_amazingdata_v3():
    ...
    try:
        ...
        record("BaseData实例", False, msg=str(e)[:40])
    ...
    try:
        ...
        try:
            data = market.query_kline(
                ["000001"], begin_date=20241101, end_date=20241130, period=10000
            )
            if data and "000001" in data:
        ...
        # 快照数据
        try:
            data = market.query_snapshot(["000001"], begin_date=20241115, end_date=20241115)
            if data and "000001" in data:
                record("快照数据", True, 1)
            else:
        ...
        record("MarketData实例", False, msg=str(e)[:40])
    ...
    try:
        ...
        record("InfoData实例", False, msg=str(e)[:40])
