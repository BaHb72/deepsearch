...
def check_webui_config():
    ...
    try:
        ...
        assert config.enabled == True, "enabled 默认值应该是 True"
...
async def check_test_fixtures():
    ...
    try:
        import pytest
        from tests.conftest import event_loop, mock_redis, isolated_redis_mock

        # 检查 event_loop fixture 的作用域
        loop_fixture = pytest.fixture(scope="function")(lambda: None)
