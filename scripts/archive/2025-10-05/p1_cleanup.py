...
class P1Cleanup:
    ...
    def cleanup_third_party_docs(self):
        """将third_party中的文档移到docs/vendor"""
        self.log("=== 清理third_party目录文档 ===")
    ...
    def cleanup_unused_refactored(self):
        ...
        akshare_refactored = (
            self.project_root
            / "deepsearch/infrastructure/providers/implementations/akshare/akshare_refactored.py"
        )
    ...
    def generate_api_cleanup_list(self):
        ...
        # 这些是前端定义但后端未实现的API模块
        unused_api_modules = ["cache", "chart", "stockComment", "systemConfig（部分）"]
