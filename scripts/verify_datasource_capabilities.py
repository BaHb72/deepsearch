...
class CapabilityTester:
    ...
    def _record(self, source: str, capability: str, success: bool, 
                data_count: int = 0, message: str = "", sample: Any = None):
        """记录测试结果"""
        ...
        try:
            ...
            try:
                ...
                if result and len(result) > 0:
                    self._record("akshare", "STOCK_LIST", True, len(result), 
            ...
            try:
                ...
                if result and not result.get("error"):
                    ...
                    self._record("akshare", "REALTIME_QUOTE", False, 
            ...
            try:
                ...
                if result and result.get("data"):
                    ...
                    self._record("akshare", "KLINE_DATA", False, 
                                message=result.get("error", "无数据")[:50] if result else "无数据")
            except Exception as e:
            ...
            try:
                ...
                if result and not result.get("error"):
                    ...
                    self._record("akshare", "STOCK_INFO", False, 
                                message=result.get("error", "无数据")[:50] if result else "无数据")
            except Exception as e:
