...
from deepsearch.data_providers.data_source_manager import get_data_source_manager
...
async def test_data_source(symbol: str, source: str = None):
    ...
    """
    try:
        from deepsearch.data_providers.data_source_manager import DataSourceType
