...
from deepsearch.backtest.strategy import BacktraderStrategyAdapter
...
class BacktestService:
        ...
        try:
            ...
            for symbol in symbols:
                ...
                if not df.empty:
                    ...
                    data = self.adapter.create_backtrader_feed(df, name=symbol)
            ...
            if hasattr(strategy.analyzers, 'trades'):
                ...
                if lost.get('pnl', {}).get('total', 0) != 0:
                    result.profit_factor = abs(won.get('pnl', {}).get('total', 0) /
                                               lost.get('pnl', {}).get('total', 0))
    ...
    def _generate_plot(self, cerebro: bt.Cerebro) -> Optional[str]:
        """
