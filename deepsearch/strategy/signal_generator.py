...
class SignalGenerator:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # Signal cache
        self.signal_history = []
        self.last_signals = {}  # {symbol: last_signal}
    ...
    def filter_signals(self,
                       ...
                       max_signals: int = 10) -> List[TradingSignal]:
        """
        ...
        sorted_signals = sorted(
            signals,
            key=lambda s: (s.strength.value, abs(s.indicators.get('rsi', 50) - 50)),
            reverse=True
        )
    ...
    def add_signal_rule(self, rule: Callable[[TradingSignal, Dict], bool]):
        """
    ...
    def get_signal_statistics(self) -> Dict[str, Any]:
        ...
        sell_signals = sum(1 for s in self.signal_history
