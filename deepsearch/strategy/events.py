...
class StrategyEventFactory:
    ...
    @staticmethod
    def create_signal_event(strategy_id: str,
                            symbol: str,
                            signal_type: str,
                            **kwargs) -> SignalEvent:
        """Create signal event"""
    ...
    @staticmethod
    def create_order_event(strategy_id: str,
                           order_id: str,
                           symbol: str,
                           side: str,
                           size: float,
    ...
    @staticmethod
    def create_position_event(strategy_id: str,
                              symbol: str,
                              position_size: float,
                              **kwargs) -> PositionEvent:
    ...
    @staticmethod
    def create_risk_event(strategy_id: str,
                          risk_type: str,
                          current_value: float,
                          limit_value: float,
                          **kwargs) -> RiskEvent:
    ...
    @staticmethod
    def create_performance_event(strategy_id: str,
                                 **metrics) -> PerformanceEvent:
        """Create performance event"""
        return PerformanceEvent(
            event_type=StrategyEventType.PERFORMANCE_UPDATE,
            strategy_id=strategy_id,
            **metrics
        )

    @staticmethod
    def create_lifecycle_event(event_type: StrategyEventType,
                               strategy_id: str,
                               **data) -> StrategyEvent:
