...
from deepsearch.infrastructure.providers.adapters.base import BaseProviderAdapter
...
def initialize_unified_feed(
    ...
    from deepsearch.infrastructure.providers.reference_capability import (
        IStockListProvider,
...
def start_aggregation_engine() -> None:
    ...
    # 导入聚合模块（触发注册）
    from deepsearch.application.services.aggregation import get_engine
