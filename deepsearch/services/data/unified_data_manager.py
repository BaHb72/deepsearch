        ...
        for source_type in sources:
            try:
                ...
                self.monitor.record_access(
                    ...
                    latency_ms=latency,
                    symbol=symbol,
                    module="UnifiedDataManager.get_stock_hist",
                ...
                timeout_latency = self.timeout * 1000
                self._update_stats(source_type, False, timeout_latency)
                ...
                error_latency = (time.time() - start_time) * 1000 if 'start_time' in locals() else 0
                self._update_stats(source_type, False, error_latency)
        ...
        for source_type in sources:
            try:
                ...
                self.monitor.record_access(
                    ...
                    latency_ms=latency,
                    symbol=symbol,
                    module="UnifiedDataManager.get_realtime_quote",
                    data_size=len(str(result))
                )
        ...
        for source_type in sources:
            try:
                ...
                self.monitor.record_access(
                    ...
                    latency_ms=latency,
                    symbol=symbol,
                    module="UnifiedDataManager.fetch_stock_info",
                    data_size=len(str(result))
                )
