...
from deepsearch.ports.market_data.subscription import SubscriberPriority
...
class TTradingSubscriber:
    ...
    async def _check_strategies_for_code(self, code: str, current_price: float) -> None:
        ...
        try:
            from deepsearch.infrastructure.trading.ttrading_service import get_ttrading_service
