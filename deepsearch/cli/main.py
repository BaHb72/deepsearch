...
def run(env, mode, config, log_level, no_frontend, open_browser, status_display):
    ...
    from deepsearch.core.runtime.async_runner import run_async_engine
    from deepsearch.observability.logger import logger_manager
    from deepsearch.utils.system.port_checker import PortChecker
    from deepsearch.utils.system.redis_startup import RedisStartupError, ensure_redis_running
...
# 添加调试命令组（仅在开发模式下可用）
try:
    from deepsearch.cli.debug_commands import debug
