...
def test_kline_data():
    ...
    for symbol in TEST_SYMBOLS[:2]:  # 只测试前两个
        ...
        msg = {"type": "HISTORY_DATA", "symbol": symbol, "period": "1d", "data": klines}
...
def test_subscription():
    ...
    # 发送订阅请求
    sub_msg = {"type": "SUBSCRIBE", "symbols": TEST_SYMBOLS}
...
def test_stress():
    ...
    log(
        "SUCCESS",
        "Stress test completed: %d messages in %.2fs (%.1f msg/s)"
            ...
            while g_running:
                ...
                if int(time.time()) % 10 == 0:
                    ...
                    log(
                        ...
                        % (
                            uptime,
                            g_perf_stats["total_sent"],
                            g_perf_stats["total_received"],
                            g_perf_stats["total_errors"],
                        ),
                    )
