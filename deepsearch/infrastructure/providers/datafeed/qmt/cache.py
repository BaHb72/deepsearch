...
class MultiLevelCache:
    ...
    def __init__(self,
        ...
        try:
            ...
            logger.warning(f"Redis cache connection failed: {e}, will use memory and file cache only")
            self.redis_client = None
    ...
    def get(self, key_type: str, period: str = None, **kwargs) -> Optional[Any]:
        """
        获取缓存数据（三级查找）
    ...
    def set(self, key_type: str, value: Any, period: str = None, **kwargs) -> bool:
        """
        设置缓存数据（三级写入）
    ...
    def clear(self, key_type: str = None, **kwargs):
        """
        清除缓存
