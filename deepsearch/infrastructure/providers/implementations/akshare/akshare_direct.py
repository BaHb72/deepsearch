...
from deepsearch.core.utils.async_timeout import timeout_decorator, run_with_timeout
...
class AKShareDirectProvider:
    ...
    @timeout_decorator(
        seconds=10.0,  # 使用固定超时值或从TimeoutManager获取
    ...
    @timeout_decorator(
        seconds=30.0,  # 历史数据使用更长的超时
        default={"data": [], "error": "timeout"}
    )
