            ...
            for symbol in symbols:
                if symbol in tick_data:
                    ...
                    result[symbol] = {
                        ...
                        'pct_change': ((tick.get('lastPrice', 0) - tick.get('lastClose', 0))
                                       / tick.get('lastClose', 1) * 100 if tick.get('lastClose', 0) > 0 else 0),
                        # 基础五档（免费版通常有）
