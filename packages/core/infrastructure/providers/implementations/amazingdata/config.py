...
from core.infrastructure.providers.interfaces.base import DataProviderConfig, DataSourceType
...
class AmazingDataConfig(DataProviderConfig):
    ...
    def __init__(self, username: str, password: str, host: str, port: int, **kwargs):
        ...
        distributed_session_enabled = kwargs.pop("distributed_session_enabled", True)
        ...
        self.distributed_session_enabled = distributed_session_enabled
