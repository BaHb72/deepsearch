...
from core.ports.data.requests import KlineRequest, StockListRequest
from core.ports.data.responses import KlineBar, KlineResponse, StockInfo, StockListResponse
from core.ports.data.semantic_types import AdjustType, AssetSpec, Exchange, Timeframe
