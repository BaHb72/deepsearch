...
from core.ports.data.requests import KlineRequest, RealtimeQuoteRequest, TickRequest
...
from core.ports.data.semantic_types import AdjustType, AssetSpec, Timeframe
