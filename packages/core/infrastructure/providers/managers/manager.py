...
from core.infrastructure.providers.interfaces.capabilities import (
    DataCapability,
    check_provider_capability,
    get_capable_providers,
)
from core.infrastructure.providers.interfaces.payloads import DataPayload
...
class DataProviderManager:
    ...
    def _create_provider(self, config: Dict[str, Any]) -> Optional[DataProvider]:
        ...
        DEFAULT_PROVIDER_MAPPING: Dict[str, tuple] = {
            ...
            "AmazingData": (
                "core.infrastructure.providers.implementations.amazingdata.amazingdata_optimized",
