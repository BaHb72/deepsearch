...
from core.config.models.database import AnalyticsDatabaseConfig
...
if TYPE_CHECKING:  # pragma: no cover - 仅用于类型检查
    from core.infrastructure.persistence.duckdb_analytics import DuckDBAnalytics
    from core.infrastructure.providers.managers.data_sync_pipeline import DataSyncPipeline
    from core.infrastructure.providers.managers.data_sync_service import DataSyncService
...
class AnalyticsComponent(AsyncComponent):
    ...
    async def _do_initialize(self) -> None:
        ...
        from core.infrastructure.providers.managers.pipeline_setup import create_sync_pipeline
