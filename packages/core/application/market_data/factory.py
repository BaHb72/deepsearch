...
from core.config.models.market_data import MarketRealtimeConfig, MarketWindowConfig
...
from core.ports.market_data import MarketDataPortRegistry, WindowSpec
...
# Arrow 文件缓存
try:
    from core.adapters.market_data.snapshot_cache_adapter import ArrowSnapshotCacheAdapter
...
if TYPE_CHECKING:
    from core.infrastructure.providers.implementations.amazingdata import AmazingDataProvider
...
def create_realtime_market_data_service(
    ...
    *,
    ...
    if registry is None:
        ...
        from core.infrastructure.providers.implementations.amazingdata.ports import (
