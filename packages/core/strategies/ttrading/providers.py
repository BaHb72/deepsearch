...
import pandas as pd
from core.strategies.ttrading.interfaces import IntradayDataProvider, QuoteSnapshot
...
try:
    from core.adapters.market_data.miniqmt_polling_adapter import MiniQMTPollingStreamPort
